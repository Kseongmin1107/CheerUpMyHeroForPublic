# 본 레포지토리는 퍼블릭용 레포지토리라서 게임 실행은 어렵습니다. 
# 아래 링크로 가서 게임 플레이 해주세요!
-> https://gyro1515.itch.io/chearupmyherotest
...
-  **이벤트 매니저 구현**
 ...
 - 개선사항:
  ...
  -  **배틀씬 사용 버튼 개선**
   ...
   -    개선사항:
      -  전투 씬에서 유닛/유물 아이콘을 **짧게 클릭**하면 즉시 소환/사용되도록 하고, **길게 클릭**할 경우에는 해당 유닛/유물의 **상세 정보 팝업**이 표시되도록 이벤트를 분리하여, 플레이어가 전투 중에도 직관적으로 정보를 확인할 수 있게 개선
